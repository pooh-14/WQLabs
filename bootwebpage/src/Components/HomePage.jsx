      ...
      <div id="main">
        ...
        <div id="grid">
          <div class="row mainone">
            <div class="col-4 lambu">
              <div class="row justify-content-between">
                <div class="col-6 chintu d-flex ">
                  <div>
                    <p>Total People</p>
                    <h4>267</h4>
                  </div>
            ...
            <div class="col-4 lambu">
              ...
              <div class="row" id="outoffice">
                <div>
                  <p class="m-0"><b>Who is out of Office</b></p>
                </div>
                <div>
                  <div class="d-flex ">
                  ...
                  <div class="d-flex ">
                    ...
                    <div>
                      ...
                      <p class="m-0">Senior Forntend Developer</p>
                    </div>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div class="d-flex ">
                    ...
                    <div>
                      ...
                      <p class="m-0">Junior UI/UX Designer</p>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-4 lambu2" id="calender">
              Calender
            </div>
          </div>

          <div class="row maintwo">
            <div class="col-9 border " id="annouce ">
              <div class="d-flex">
                <p>Announcements</p>
                <p>+ Add New</p>
              </div>
